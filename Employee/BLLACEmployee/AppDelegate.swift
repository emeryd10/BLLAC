...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func getIconBadge() {
        
        DBProvider.Instance.apptRef.observeSingleEvent(of: .value, with: { (snapshot:FIRDataSnapshot) in
            print("temp:" + String(snapshot.childrenCount))
            UIApplication.shared.applicationIconBadgeNumber = Int(snapshot.childrenCount)
        })
    }
